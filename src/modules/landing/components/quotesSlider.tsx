...
// name
// t("about:Avelino Rodríguez")
// t("about:Rosa Adela López Zuckermann")
// t("about:Annmarie Meier")
// t("about:Luis Chávez")
// t("about:Inti Cordera")

// quote
// t("about:Durante más de una década La Brújula se ha posicionado como un recurso de uso obligado para los productores ya que integra a todos los elementos del ecosistema de la industria en una herramienta práctica últil y siempre actualizada.")
