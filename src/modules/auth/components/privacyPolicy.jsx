    ...
    <div className="flex flex-col gap-4 mt-8 ">
      ...
      <div className="flex flex-row gap-8 py-8 text-primary items-center h-48 xl:isolate">
        ...
        <p className="grow text-left">
          {t(
            'Estoy de acuerdo con el uso de mi información según se describe en el aviso de privacidad.'
          )}
        </p>
        <div
          className="w-24 h-24 font-bold text-white flex text-xl
        items-center justify-center rounded-full bg-primary cursor-pointer shrink-0"
          onClick={(ev) => {
            ev.preventDefault();
