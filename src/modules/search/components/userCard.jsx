...
export const UserCard = ({ user }) => {
  return (
    <NavLink
      ...
      className="grid grid-cols-[5rem_1fr_1fr] lg:grid-cols-[5rem_5fr_4fr] gap-8
      border-b-black border-b border-opacity-40 pb-6 gap-y-4"
    >
      ...
      <div
        ...
        border-opacity-40 col-span-2 lg:col-span-1"
      >
      ...
      <div className="col-span-2 lg:col-span-1">
        ...
        <p className="text-xs mt-2">{[user.city, user.state].join(', ')}</p>
      </div>
      <p className="text-sm opacity-70 text-black col-span-2 lg:col-span-1">
        {user.headline}
      </p>
